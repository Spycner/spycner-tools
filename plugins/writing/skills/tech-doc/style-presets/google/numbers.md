...
- Spell out zero through nine in regular prose. Use numerals for 10 and above.
- Always use numerals for: version numbers, technical quantities (memory, disk space, queries per second), page/chapter/step numbers, prices, and numbers in math expressions.
- When a number below 10 appears alongside a number 10 or above and they refer to the same category, use numerals for both: "3 to 12 items."
- When two numbers that refer to different things must appear together, spell out one: "fifteen 100,000-byte files."
- Do not start a sentence with a numeral. Rearrange the sentence if needed.
- Use words for large approximate quantities: "millions of users," not "1,000,000s of users."

## Units of measurement

- Use a non-breaking space between the numeral and the unit: "64 GB," "100 ms."
- Use standard SI abbreviations. Do not invent abbreviations.
- Do not pluralize unit abbreviations: "5 MB," not "5 MBs."
- Dimensions: use a lowercase "x" with no spaces: "192x192 pixels."
- Spell out "by" in non-technical dimension descriptions: "a 10-foot cable."
...
- Avoid numeric-only formats (6/12/2017) because month/day order varies by region.
- Do not use ordinal numbers in dates: "June 1," not "June 1st."
- Do not reference seasons (spring, summer, fall, winter); use months or quarters instead.

## Time

- Use the 12-hour clock by default.
- Capitalize AM and PM; put one space before: "3:45 PM," "10:00 AM."
